...
class DetailsActivityTest {
    ...
    fun activityCreateIntent_HasCount() {
        val intent = DetailsActivity.getIntent(context, TEST_RESPONSE_SEARCH_COUNT)
        val bundle = intent.extras
        assertEquals(TEST_RESPONSE_SEARCH_COUNT, bundle?.getInt(DetailsActivity.TOTAL_COUNT_EXTRA, 0))
    }
